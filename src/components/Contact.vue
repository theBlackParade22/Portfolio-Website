      ...
      <div class="icon logo">
        ...
        <span>
          <a href="https://t.me/harisaresh" target="_blank" rel="noopener noreferrer">
            <font-awesome-icon class="fa-telegram fa-lg" icon="fa-brands fa-telegram" />
          </a>
        </span>
      </div>
    </div>
      ...
      <div class="icon logo">
        ...
        <span
          ><a
            ...
            target="_blank"
            rel="noopener noreferrer"
            ><font-awesome-icon class="fa-github fa-lg" icon="fab fa-github" /></a
        ></span>
      </div>
    </div> -->
    <div style="margin-top: 1.2rem">
      <a
        href="https://drive.google.com/file/d/1sHEB2UN4OH7uIAB9fkHFLmoa0wXOQWJ9/view?usp=sharing"
      >
        <div class="contact-me"><b>View Resume 📄</b></div>
      </a>
    </div>
  </div>
</template>
